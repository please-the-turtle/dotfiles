...
function ExitScreen:create_button (name, icon, cmd)
  ...
  button.icon_wrapper:connect_signal("button::release", cmd)
  button.icon_wrapper.second:set_shape(
    function (cr, w, h) gears.shape.rounded_rect(cr, w, h, beautiful.border_radius) end
  )
...
function ExitScreen:get_mousebindings ()
  return gears.table.join(
    ...
    awful.button({}, 2, commands.cancel),

    -- Right click - Hide exit_screen
    awful.button({}, 3, commands.cancel)
  )
end
